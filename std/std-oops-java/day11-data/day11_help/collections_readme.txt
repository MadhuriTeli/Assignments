...
Objectives in Integer list (Can try these objectives as extra practice)
...
NOTE : 
For searching or removing based upon primary key , in List Implementation classes --- All search methods (contains,indexOf,lastIndexOf,remove(Object o)) --are based upon equals method(of type of List eg --Account/Customer/Emp....)
For correct working
