...
Its better for  application objects(service layer/controller/rest controller) to focus on the business domain problems that they are designed for and leave certain ASPECTS to be handled by someone else.
