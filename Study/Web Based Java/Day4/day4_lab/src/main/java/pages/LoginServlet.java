...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try (PrintWriter pw = response.getWriter()) {
			...
			//	pw.flush();Un comment this to understand : IllegalStateExc : Can NOT call sendRedirect ,
				//after commititng the resp(pw.flush)
				...
				// sts code : SC302 | location=topics , content-length=0,Set-cookie :  validated_user_dtls : toString of user
				//| body : EMPTY
