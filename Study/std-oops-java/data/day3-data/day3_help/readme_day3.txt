...
Revise mem picture n garbage collection (GC) using TestBox.java
Solve : TestParamPassing2 n 3
...
Objective : Add Box.java in com.app.core package & TestBox.java in com.app.tester package
Test it.
