...
app.get("/api/orderitems",
    (request, response) => {
        var selectAllQuery = "select * from order_items ";
...
app.get("/api/orderitems/:id", (request, response) => {
    ...
    var selectWithId = " select * from order_items where  order_items_id =" + id;
    sql.query(selectWithId, function (err, data) {
        if (err) {
            console.log(err);
        }
        else {
...
app.get("/api/orders/:id", (request, response) => {
    let id = request.params.id;
    var selectWithId = " select * from orders where  order_id =" + id;
    sql.query(selectWithId, function (err, data) {
        if (err) {
            console.log(err);
        }
...
app.get("/api/customerorders/:id", (request, response) => {
    let id = request.params.id;
    var selectWithId = " select * from orders where   cust_id =" + id;
    sql.query(selectWithId, function (err, data) {
        if (err) {
            console.log(err);
        }
